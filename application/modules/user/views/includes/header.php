                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="<?php echo site_url('ubah_password') ?>" class="btn btn-info outline btn-sm"><i class="fas fa-key"></i>Ubah Password</a>
                                </div>
                                <div class="pull-right">
                                    <a href="<?php echo site_url('logout') ?>" class="btn btn-danger outline btn-sm"><i class="fas fa-sign-out-alt"></i>Keluar</a>
                                </div>
                            </li>
                        </ul>
                    </li>
