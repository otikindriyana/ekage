...
<head>
    ...
    <!-- <link href="<?php echo base_url(); ?>assets/js/datepicker/css/bootstrap-datetimepicker.min.css" rel="stylesheet" type="text/css"/> -->
    <link href="<?php echo base_url(); ?>assets/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css" rel="stylesheet" type="text/css"/>
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li>
                    <a href="<?php echo site_url('laporan')?>">
                        <i class="fa fa-file-o"></i> <span>Laporan Transaksi</span>
